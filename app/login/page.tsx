  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-black via-zinc-950 to-black text-white">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-40 right-[-10%] h-[40rem] w-[40rem] rounded-full bg-white/10 blur-3xl opacity-20" />
        <div className="absolute left-1/2 top-0 -translate-x-1/2 h-px w-[80%] bg-gradient-to-r from-transparent via-white/20 to-transparent" />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-screen-xl items-center justify-center px-4">
        <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8 shadow-2xl backdrop-blur-xl">
          {/* header */}
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                autoComplete="email"
                inputMode="email"
                className="w-full rounded-2xl bg-white/5 border border-white/10 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-white/20"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-2xl bg-white/5 border border-white/10 px-3 py-2 pr-10 text-sm outline-none focus:ring-2 focus:ring-white/20"
                  placeholder="••••••••"
                  value={password}
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-2 my-auto inline-flex h-7 w-7 items-center justify-center rounded-md bg-white/10 text-white/80 hover:bg-white/15"
                  tabIndex={0}
                >
                  {showPw ? (
                    // eye-off
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-1 w-full rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-black shadow-lg shadow-white/10 transition active:scale-[.98] disabled:opacity-60"
            >
